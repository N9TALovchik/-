...
adminGroup:AddLabel('Text Color'):AddColorPicker('AdminESPColor', {
...
local function updateAdminESP()
    ...
    local color = Options.AdminESPColor.Value or Color3.fromRGB(255, 255, 0)
...
Options.AdminESPColor:OnChanged(function()
