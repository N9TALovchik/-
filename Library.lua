-- Library.lua (полная версия с поддержкой прозрачности)
...
function Library:CreateLabel(Properties, IsHud)
    local _Instance = Library:Create('TextLabel', {
        ...
        TextTransparency = Library.FontTransparency,
        TextSize = 16,
    ...
    Library:AddToRegistry(_Instance, {
        ...
        TextTransparency = 'FontTransparency',
    }, IsHud)
    ...
    for Idx, Object in next, Library.Registry do
        for Property, Key in next, Object.Properties do
            if type(Key) == 'string' then
                Object.Instance[Property] = Library[Key]
            elseif type(Key) == 'function' then
                Object.Instance[Property] = Key()
            end
        end
    end
end
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local Highlight = Library:Create('Frame', {
            ...
            BackgroundTransparency = Library.AccentTransparency,
            BorderSizePixel = 0,
        ...
        Library:AddToRegistry(PickerFrameInner, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency', BorderColor3 = 'OutlineColor' })
        Library:AddToRegistry(Highlight, { BackgroundColor3 = 'AccentColor', BackgroundTransparency = 'AccentTransparency' })
        Library:AddToRegistry(SatVibMapInner, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency', BorderColor3 = 'OutlineColor' })
        Library:AddToRegistry(HueBoxInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        Library:AddToRegistry(RgbBoxBase.Frame, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        Library:AddToRegistry(RgbBox, { TextColor3 = 'FontColor', TextTransparency = 'FontTransparency' })
        Library:AddToRegistry(HueBox, { TextColor3 = 'FontColor', TextTransparency = 'FontTransparency' })
        local SequenceTable = {}
        for Hue = 0, 1, 0.1 do
        ...
        function ColorPicker:Display()
            ...
            if TransparencyBoxInner then
                ...
                TransparencyBoxInner.BackgroundTransparency = ColorPicker.Transparency
...
do
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateBaseButton(Button)
            ...
            Library:AddToRegistry(Inner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
    ...
    function Funcs:AddDivider()
        ...
        Library:AddToRegistry(DividerInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        Groupbox:AddBlank(9)
        Groupbox:Resize()
    end
    function Funcs:AddInput(Idx, Info)
        ...
        Library:AddToRegistry(TextBoxInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        ...
        Library:AddToRegistry(Box, { TextColor3 = 'FontColor', TextTransparency = 'FontTransparency' })
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        Library:AddToRegistry(ToggleInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        ...
        function Toggle:Display()
            ...
            ToggleInner.BackgroundTransparency = Toggle.Value and Library.AccentTransparency or Library.MainTransparency
            ToggleInner.BorderColor3 = Toggle.Value and Library.AccentColorDark or Library.OutlineColor
            Library.RegistryMap[ToggleInner].Properties.BackgroundColor3 = Toggle.Value and 'AccentColor' or 'MainColor'
            Library.RegistryMap[ToggleInner].Properties.BackgroundTransparency = Toggle.Value and 'AccentTransparency' or 'MainTransparency'
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        Library:AddToRegistry(SliderInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        ...
        Library:AddToRegistry(Fill, { BackgroundColor3 = 'AccentColor', BackgroundTransparency = 'AccentTransparency', BorderColor3 = 'AccentColorDark' })
        ...
        Library:AddToRegistry(HideBorderRight, { BackgroundColor3 = 'AccentColor', BackgroundTransparency = 'AccentTransparency' })
        local DisplayLabel = Library:CreateLabel({
            Size = UDim2.new(1, 0, 1, 0),
            TextSize = 14,
            Text = 'Infinite',
        ...
        function Slider:UpdateColors()
            ...
            Fill.BackgroundTransparency = Library.AccentTransparency
            Fill.BorderColor3 = Library.AccentColorDark
            HideBorderRight.BackgroundColor3 = Library.AccentColor
            HideBorderRight.BackgroundTransparency = Library.AccentTransparency
        end
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        Library:AddToRegistry(DropdownInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        Library:Create('UIGradient', {
            Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(212, 212, 212))
        ...
        Library:AddToRegistry(ListInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
        ...
        function Dropdown:BuildDropdownList()
            ...
            for Idx, Value in next, Values do
                ...
                Library:AddToRegistry(Button, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
...
do
    ...
    Library:AddToRegistry(KeybindInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' }, true)
    ...
    Library:AddToRegistry(ColorFrame, { BackgroundColor3 = 'AccentColor', BackgroundTransparency = 'AccentTransparency' }, true)
...
function Library:Notify(Text, Time)
    ...
    Library:AddToRegistry(NotifyInner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' }, true)
    local InnerFrame = Library:Create('Frame', {
        BackgroundColor3 = Color3.new(1, 1, 1),
        BorderSizePixel = 0,
        Position = UDim2.new(0, 1, 0, 1),
    ...
    Library:AddToRegistry(LeftColor, { BackgroundColor3 = 'AccentColor', BackgroundTransparency = 'AccentTransparency' }, true)
...
function Library:CreateWindow(...)
    ...
    Library:AddToRegistry(Inner, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'AccentColor' })
    ...
    Library:AddToRegistry(MainSectionOuter, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency', BorderColor3 = 'OutlineColor' })
    ...
    Library:AddToRegistry(MainSectionInner, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency' })
    ...
    Library:AddToRegistry(TabContainer, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency', BorderColor3 = 'OutlineColor' })
    ...
    function Window:AddTab(Name)
        ...
        Library:AddToRegistry(TabButton, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency', BorderColor3 = 'OutlineColor' })
        ...
        Library:AddToRegistry(Blocker, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency' })
        ...
        function Tab:ShowTab()
            ...
            TabButton.BackgroundTransparency = Library.MainTransparency
            Library.RegistryMap[TabButton].Properties.BackgroundColor3 = 'MainColor'
            Library.RegistryMap[TabButton].Properties.BackgroundTransparency = 'MainTransparency'
            TabFrame.Visible = true
        end
        function Tab:HideTab()
            Blocker.BackgroundTransparency = 1
            TabButton.BackgroundColor3 = Library.BackgroundColor
            TabButton.BackgroundTransparency = Library.BackgroundTransparency
            Library.RegistryMap[TabButton].Properties.BackgroundColor3 = 'BackgroundColor'
            Library.RegistryMap[TabButton].Properties.BackgroundTransparency = 'BackgroundTransparency'
        ...
        function Tab:AddGroupbox(Info)
            ...
            Library:AddToRegistry(BoxOuter, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency', BorderColor3 = 'OutlineColor' })
            ...
            Library:AddToRegistry(BoxInner, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency' })
            local Highlight = Library:Create('Frame', {
                BackgroundColor3 = Library.AccentColor,
                BackgroundTransparency = Library.AccentTransparency,
                BorderSizePixel = 0,
        ...
        function Tab:AddTabbox(Info)
            ...
            function Tabbox:AddTab(Name)
                ...
                Library:AddToRegistry(Button, { BackgroundColor3 = 'MainColor', BackgroundTransparency = 'MainTransparency' })
                local ButtonLabel = Library:CreateLabel({
                    Size = UDim2.new(1, 0, 1, 0),
                    TextSize = 14,
                    Text = Name,
                ...
                Library:AddToRegistry(Block, { BackgroundColor3 = 'BackgroundColor', BackgroundTransparency = 'BackgroundTransparency' })
                local Container = Library:Create('Frame', {
                    BackgroundTransparency = 1,
                    Position = UDim2.new(0, 4, 0, 20),
                    Size = UDim2.new(1, -4, 1, -20),
                ...
                function Tab:Show()
                    ...
                    Button.BackgroundTransparency = Library.BackgroundTransparency
                    Library.RegistryMap[Button].Properties.BackgroundColor3 = 'BackgroundColor'
                    Library.RegistryMap[Button].Properties.BackgroundTransparency = 'BackgroundTransparency'
                    Tab:Resize()
                end
                function Tab:Hide()
                    ...
                    Button.BackgroundTransparency = Library.MainTransparency
                    Library.RegistryMap[Button].Properties.BackgroundColor3 = 'MainColor'
                    Library.RegistryMap[Button].Properties.BackgroundTransparency = 'MainTransparency'
                end
                function Tab:Resize()
                    local TabCount = 0
